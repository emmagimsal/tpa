...
//	@Query("from Persona u where u.nombre:nombre and u.apellido =:apellido order by u.nombre asc ")
//	Page<Persona> findByApellidoNombre(Pageable pag, @Param("apellido") String apellido, @Param("nombre") String nombre);
//	
//	
//	@Query("from Persona u where u.nombre = ?1 and u.apellido = ?2 order by u.nombre asc ")
//	Page<Persona> findByApellidoNombre2(Pageable pag, String apellido, String nombre);
//	
//	
//	Page<Persona> findByNombreAndApellido(String nombre, String apellido);
